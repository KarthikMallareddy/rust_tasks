...
import { encryptVault, decryptVault, validateVaultEntry, createVaultEntry, } from "../src/vault.js";
...
test("Vault: Each encryption produces unique ciphertext", async () => {
    ...
    assert.notEqual(encrypted1.ciphertext, encrypted2.ciphertext, "Different encryptions should produce different ciphertexts");
    assert.notEqual(encrypted1.iv, encrypted2.iv, "Different encryptions should have different IVs");
    assert.notEqual(encrypted1.salt, encrypted2.salt, "Different encryptions should have different salts");
});
